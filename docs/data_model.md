...
GOPATH=/Users/L.Querel/go #gosetup
...
```mermaid
erDiagram
    LOGS ||--o{ resource_logs : resource_logs
    resource_logs ||--o{ scope_logs : scope_logs
    scope_logs ||--o{ logs : logs
    ...
    logs{
        ...
        body union "str|i64|f64|bool|binary|cbor, optional"
