...
var file_opentelemetry_proto_collector_arrow_v1_arrow_service_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x72, 0x73, 0x22, 0xfd, 0x01, 0x0a, 0x10, 0x4f, 0x74, 0x6c, 0x70, 0x41, 0x72, 0x72,
	...
	0x16, 0x0a, 0x06, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x06, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x5b, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x70, 0x72,
...
var file_opentelemetry_proto_collector_arrow_v1_arrow_service_proto_depIdxs = []int32{
	...
	2,  // 3: opentelemetry.proto.collector.arrow.v1.OtlpArrowPayload.compression:type_name -> opentelemetry.proto.collector.arrow.v1.CompressionMethod
	9,  // 4: opentelemetry.proto.collector.arrow.v1.BatchStatus.statuses:type_name -> opentelemetry.proto.collector.arrow.v1.StatusMessage
	3,  // 5: opentelemetry.proto.collector.arrow.v1.StatusMessage.status_code:type_name -> opentelemetry.proto.collector.arrow.v1.StatusCode
	4,  // 6: opentelemetry.proto.collector.arrow.v1.StatusMessage.error_code:type_name -> opentelemetry.proto.collector.arrow.v1.ErrorCode
	10, // 7: opentelemetry.proto.collector.arrow.v1.StatusMessage.retry_info:type_name -> opentelemetry.proto.collector.arrow.v1.RetryInfo
	5,  // 8: opentelemetry.proto.collector.arrow.v1.ArrowStreamService.ArrowStream:input_type -> opentelemetry.proto.collector.arrow.v1.BatchArrowRecords
	8,  // 9: opentelemetry.proto.collector.arrow.v1.ArrowStreamService.ArrowStream:output_type -> opentelemetry.proto.collector.arrow.v1.BatchStatus
