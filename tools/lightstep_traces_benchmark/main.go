...
func main() {
	...
	maxIter := uint64(1)
	ds := dataset.NewLightstepTracesDataset("/Users/L.Querel/GolandProjects/otel-arrow-adapter/data/hipster_shop.yaml", 100000)
	...
	profiler.ExportMetricsTimesCSV(fmt.Sprintf("%d_traces_benchmark_results", 0))
	profiler.ExportMetricsBytesCSV(fmt.Sprintf("%d_traces_benchmark_results", 0))
