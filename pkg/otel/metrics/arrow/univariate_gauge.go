...
// NewUnivariateGaugeBuilder creates a new UnivariateGaugeBuilder with a given memory allocator.
...
// UnivariateGaugeBuilderFrom creates a new UnivariateGaugeBuilder from an existing StructBuilder.
