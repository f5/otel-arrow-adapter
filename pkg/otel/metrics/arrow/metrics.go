...
var (
	MetricsSchema = arrow.NewSchema([]arrow.Field{
		...
		{Name: constants.Resource, Type: carrow.ResourceDT, Nullable: true},
		{Name: constants.Scope, Type: carrow.ScopeDT, Nullable: true},
		...
		{Name: constants.Description, Type: arrow.BinaryTypes.String, Metadata: schema.Metadata(schema.Dictionary8), Nullable: true},
		{Name: constants.Unit, Type: arrow.BinaryTypes.String, Metadata: schema.Metadata(schema.Dictionary8), Nullable: true},
		{Name: constants.AggregationTemporality, Type: arrow.PrimitiveTypes.Int32, Metadata: schema.Metadata(schema.Dictionary8), Nullable: true},
		{Name: constants.IsMonotonic, Type: arrow.FixedWidthTypes.Boolean, Nullable: true},
	}, nil)
)
